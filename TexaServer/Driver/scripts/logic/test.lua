...
-- 同花
TaxasTable["Players"] = {
	[1] = {["OwnCard"] = {1, 8}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },
	[2] = {["OwnCard"] = {1, 2}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },
	[3] = {["OwnCard"] = {1, 2}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 }
}
...
TaxasTable["Players"] = {
	[1] = {["OwnCard"] = {22, 26}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },
	[2] = {["OwnCard"] = {2, 6}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },
	[3] = {["OwnCard"] = {1, 2}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 }
}
...
TaxasTable["Players"] = {                                               
        [1] = {["OwnCard"] = {22, 34}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },                                
        [2] = {["OwnCard"] = {2, 30}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },                                  
        [3] = {["OwnCard"] = {1, 2}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 }                                   
}                                                                       
TaxasTable["DownCards"] = {10, 14, 18, 44, 48}                          
CheckCards(TaxasTable);                                                 
...
TaxasTable["Players"] = {                                               
        [1] = {["OwnCard"] = {21, 27}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },
 	[2] = {["OwnCard"] = {23, 28}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },
	[3] = {["OwnCard"] = {1, 2}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 }
}                                                                       
TaxasTable["DownCards"] = {10, 14, 18, 44, 48}                          
CheckCards(TaxasTable);                                                 
...
TaxasTable["Players"] = {                                               
        [1] = {["OwnCard"] = {29, 35}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },                                
        [2] = {["OwnCard"] = {3, 6}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },                                  
        [3] = {["OwnCard"] = {1, 7}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 }                                   
}                                                                       
...
TaxasTable["Players"] = {                        
        [1] = {["OwnCard"] = {29, 52}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },                                
        [2] = {["OwnCard"] = {3, 6}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 },        
        [3] = {["OwnCard"] = {1, 7}, ["Flod"] = 0, ["InGameing"] = 1, ["AllIn"] = 0 }   
}                                                          
...
function getSettleTableInfo()
	...
	TaxasTable["Players"] = {}
	table.insert(TaxasTable["Players"], tPlayer1_6);
	table.insert(TaxasTable["Players"], tPlayer2_7);
	table.insert(TaxasTable["Players"], tPlayer3_8);
	table.insert(TaxasTable["Players"], tPlayer4_10);
	table.insert(TaxasTable["Players"], tPlayer5_10);
end

getSettleTableInfo();
TaxasTable["AllInPlayers"] = { [1] = 1, [3] = 1 }
TaxasTable["Pot"] = 41
TaxasTable["Wins"] = { [1] = {1, 2, 3, 4, 5} }
Settle(TaxasTable)
printTable(TaxasTable)

getSettleTableInfo();
TaxasTable["Wins"] = { [3] = {1, 2, 3, 4, 5} }
Settle(TaxasTable)
printTable(TaxasTable)

getSettleTableInfo();
TaxasTable["Wins"] = { [5] = {1, 2, 3, 4, 5} }
Settle(TaxasTable)
printTable(TaxasTable)

getSettleTableInfo();
TaxasTable["Wins"] = { [1] = {1, 2, 3, 4, 5}, [3] = {1, 2, 3, 4, 5} }
Settle(TaxasTable)
printTable(TaxasTable)

getSettleTableInfo();
TaxasTable["Wins"] = { [1] = {1, 2, 3, 4, 5}, [5] = {1, 2, 3, 4, 5} }
Settle(TaxasTable)
printTable(TaxasTable)

getSettleTableInfo();
TaxasTable["Wins"] = { [3] = {1, 2, 3, 4, 5}, [5] = {1, 2, 3, 4, 5} }
Settle(TaxasTable)
printTable(TaxasTable)
...
local tRet = PlayerEnterTable(10, 1, "100,2000,1000,9,5,10,5,1")
...
--printTable(tTable)
--
--if tTable["Gameing"] ~= 1 or tTable["PlayerCount"] ~= 3 or tTable["ButtonPlayer"] ~= 1 or tTable["SmallPlayer"] ~= 2 or tTable["BigPlayer"] ~= 3 or tTable["CurPlayer"] ~= 1 or tTable["CurMaxBet"] ~= tTable["TableInfo"]["BigBlinds"] or tTable["Pot"] ~= (tTable["TableInfo"]["BigBlinds"] + tTable["TableInfo"]["SmallBlinds"]) or tTable["CurPlayer"] ~= 1 then
--	SMD_Assert();
--end
--
--OnCall(10, tTable);
