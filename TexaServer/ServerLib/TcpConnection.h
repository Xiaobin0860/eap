...
class TcpConnection : private boost::noncopyable, public std::enable_shared_from_this<TcpConnection> {
    typedef std::function<void(uint32)>         DisconnectCallBack;
    typedef std::shared_ptr<std::vector<uint8>> BufferPtr;
