...
class basic_logger : private boost::noncopyable {
public:
     ...
     */
    explicit basic_logger(boost::asio::io_service& io_service, const std::string& identifier)
    ...
    void use_file()
    {
        ...
        time_t t = time(0);
        tm*    lt = localtime(&t);
        sprintf(filename, "./logs/log%04d%02d%02d_%02d%02d%02d.txt", lt->tm_year + 1900, lt->tm_mon + 1, lt->tm_mday,
