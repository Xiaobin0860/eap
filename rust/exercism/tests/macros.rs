...
mod test {
    ...
    fn test_macro_out_of_scope() {
        let _empty: ::std::collections::HashMap<(), ()> = exercism::hashmap!();
        let _without_comma = exercism::hashmap!(23=> 623, 34 => 21);
        let _with_trailing = exercism::hashmap!(23 => 623, 34 => 21,);
    }
}
